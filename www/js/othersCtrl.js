 myapp.controller("othersCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("others_toggle");
   ...
   $scope.otherssummaryDetails = {

     "comment": ""
 };

 var hasothersSummDetails = checkLocalStorage('otherssummaryDetails');
 console.log(hasothersSummDetails);
 if(hasothersSummDetails) {
    $scope.otherssummaryDetails=JSON.parse(localStorage.getItem("otherssummaryDetails") || {});
    console.log($scope.otherssummaryDetails);
}
...
$scope.change = function() {
    console.log($scope.otherssummaryDetails);
    localStorage.setItem('otherssummaryDetails', JSON.stringify($scope.otherssummaryDetails));
    ...
    $scope.save = function() {
      ...
      $http({
        ...
        params: {
          ...
          activitySummary: JSON.stringify($scope.otherssummaryDetails)
      }
...
if ($scope.toggle == "Start Activity") {
          ...
          console.log(response);
                ...
                if (response.data.Message == "Other Activity Present") {
                  $ionicPopup.alert({
                    ...
                    localStorage.setItem("others_toggle", "End activity"); 
        ...
        console.log(response);
                ...
                if(response.data.StatusCode==200)
                {
                   ...
                   localStorage.setItem("others_toggle", "Completed !!"); 
