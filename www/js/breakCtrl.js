 myapp.controller("breakCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("break_toggle");
   ...
   $scope.breaksummaryDetails = {

     "comment": ""
 };

 var hasbreakSummDetails = checkLocalStorage('breaksummaryDetails');
 console.log(hasbreakSummDetails);
 if(hasbreakSummDetails) {
    $scope.breaksummaryDetails=JSON.parse(localStorage.getItem("breaksummaryDetails") || {});
    console.log($scope.breaksummaryDetails);
}
...
$scope.change = function() {
    console.log($scope.breaksummaryDetails);
    localStorage.setItem('breaksummaryDetails', JSON.stringify($scope.breaksummaryDetails));
    ...
    $scope.save = function() {
      ...
      $http({
        ...
        params: {
          ...
          activitySummary: JSON.stringify($scope.breaksummaryDetails)
      }
...
if ($scope.toggle == "Start Activity") {
          ...
          console.log(response);
                ...
                if (response.data.Message == "Other Activity Present") {
                  $ionicPopup.alert({
                    ...
                    localStorage.setItem("break_toggle", "End activity"); 
        ...
        console.log(response);
                ...
                if(response.data.StatusCode==200)
                {
                   ...
                   localStorage.setItem("break_toggle", "Completed !!"); 
