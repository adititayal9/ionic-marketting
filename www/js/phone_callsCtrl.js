 myapp.controller("phone_callsCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("phone_calls_toggle");
     ...
     console.log($scope.planningDetails);s
     $scope.phone_callssummaryDetails = {
    ...
    var hasphone_callsSummDetails = checkLocalStorage('phone_callssummaryDetails');
    console.log(hasphone_callsSummDetails);
    if(hasphone_callsSummDetails) {
        $scope.phone_callssummaryDetails=JSON.parse(localStorage.getItem("phone_callssummaryDetails") || {});
        console.log($scope.phone_callssummaryDetails);
    }
     $scope.change = function() {
         console.log($scope.phone_callssummaryDetails);
         localStorage.setItem('phone_callssummaryDetails', JSON.stringify($scope.phone_callssummaryDetails));
    ...
    $scope.save = function() {
        ...
        $http({
            ...
            params: {
                ...
                activitySummary: JSON.stringify($scope.phone_callssummaryDetails)
            }
        ...
        if ($scope.toggle == "Start Activity") {
            ...
            $http({
                ...
                if (response.data.Message == "Other Activity Present") {
                    ...
                    localStorage.setItem("phone_calls_toggle", "End activity"); 
            ...
            $http({
                ...
                if(response.data.StatusCode==200)
                {
                   $ionicPopup.alert({
                    ...
                    localStorage.setItem("phone_calls_toggle", "Completed !!"); 
