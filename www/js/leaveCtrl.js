 myapp.controller("leaveCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("leave_toggle");
     ...
     $scope.leavesummaryDetails = {
         "planned": "",
         "type": "",
         "comment": ""
     };

     var hasleaveSummDetails = checkLocalStorage('leavesummaryDetails');
     console.log(hasleaveSummDetails);
     if (hasleaveSummDetails) {
         $scope.leavesummaryDetails = JSON.parse(localStorage.getItem("leavesummaryDetails") || {});
         console.log($scope.leavesummaryDetails);
     }

     $scope.change = function() {
         console.log($scope.leavesummaryDetails);
         localStorage.setItem('leavesummaryDetails', JSON.stringify($scope.leavesummaryDetails));
     }
     ...
     $scope.save = function() {
         ...
         $http({
             ...
             params: {
                 ...
                 activitySummary: JSON.stringify($scope.leavesummaryDetails)
             }
         ...
         if ($scope.toggle == "Start Activity") {
             ...
             $http({
                 ...
                 if (response.data.Message == "Other Activity Present") {
                     ...
                     localStorage.setItem("leave_toggle", "End activity");
         ...
         } else if ($scope.toggle == "End activity") //to end activity
         {
             ...
             $http({
                 ...
                 if (response.data.StatusCode == 200) {
                     ...
                     localStorage.setItem("leave_toggle", "Completed !!");
