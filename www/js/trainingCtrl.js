 myapp.controller("trainingCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("training_toggle");
   ...
   $scope.trainingsummaryDetails = {

     "comment": ""
 };

 var hastrainingSummDetails = checkLocalStorage('trainingsummaryDetails');
 console.log(hastrainingSummDetails);
 if(hastrainingSummDetails) {
    $scope.trainingsummaryDetails=JSON.parse(localStorage.getItem("trainingsummaryDetails") || {});
    console.log($scope.trainingsummaryDetails);
}
...
$scope.change = function() {
    console.log($scope.trainingsummaryDetails);
    localStorage.setItem('trainingsummaryDetails', JSON.stringify($scope.trainingsummaryDetails));
    ...
    $scope.save = function() {
      ...
      $http({
        ...
        params: {
          ...
          activitySummary: JSON.stringify($scope.trainingsummaryDetails)
      }
...
if ($scope.toggle == "Start Activity") {
          ...
          console.log(response);
                ...
                if (response.data.Message == "Other Activity Present") {
                  $ionicPopup.alert({
                    ...
                    localStorage.setItem("training_toggle", "End activity"); 
        ...
        console.log(response);
                ...
                if(response.data.StatusCode==200)
                {
                   ...
                   localStorage.setItem("training_toggle", "Completed !!"); 
