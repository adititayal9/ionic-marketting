 myapp.controller("meetingCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

     $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("meeting_toggle");
   ...
   $scope.meetingsummaryDetails = {

     "comment": ""
 };

 var hasmeetingSummDetails = checkLocalStorage('meetingsummaryDetails');
 console.log(hasmeetingSummDetails);
 if(hasmeetingSummDetails) {
    $scope.meetingsummaryDetails=JSON.parse(localStorage.getItem("meetingsummaryDetails") || {});
    console.log($scope.meetingsummaryDetails);
}
...
$scope.change = function() {
    console.log($scope.meetingsummaryDetails);
    localStorage.setItem('meetingsummaryDetails', JSON.stringify($scope.meetingsummaryDetails));
    ...
    $scope.save = function() {
      ...
      $http({
        ...
        params: {
          ...
          activitySummary: JSON.stringify($scope.meetingsummaryDetails)
      }
...
if ($scope.toggle == "Start Activity") {
          ...
          console.log(response);
                ...
                if (response.data.Message == "Other Activity Present") {
                  $ionicPopup.alert({
                    ...
                    localStorage.setItem("meeting_toggle", "End activity"); 
        ...
        console.log(response);
                ...
                if(response.data.StatusCode==200)
                {
                   ...
                   localStorage.setItem("meeting_toggle", "Completed !!"); 
