 myapp.controller("data_entryCtrl", function($scope, $state, $cordovaGeolocation, $http, $ionicPopup) {

   $scope.activityId = $state.params.activityId;
     //  console.log("hi "+$scope.activityId );
     $scope.toggle = localStorage.getItem("data_entry_toggle");
     ...
     $scope.data_entrysummaryDetails = {
       "project_details":"",

       "comment": ""
     };

     var hasdata_entrySummDetails = checkLocalStorage('data_entrysummaryDetails');
     console.log(hasdata_entrySummDetails);
     if(hasdata_entrySummDetails) {
        $scope.data_entrysummaryDetails=JSON.parse(localStorage.getItem("data_entrysummaryDetails") || {});
        console.log($scope.data_entrysummaryDetails);
    }
    ...
    $scope.change = function() {
        console.log($scope.data_entrysummaryDetails);
        localStorage.setItem('data_entrysummaryDetails', JSON.stringify($scope.data_entrysummaryDetails));
    ...
    $scope.save = function() {
      ...
      $http({
        ...
        params: {
          ...
          activitySummary: JSON.stringify($scope.data_entrysummaryDetails)
        }
              ...
              console.log(response);
                ...
                if (response.data.Message == "Other Activity Present") {
                  $ionicPopup.alert({
                    ...
                    localStorage.setItem("data_entry_toggle", "End activity"); 
          ...
          $http({
            ...
            console.log(response);
                ...
                if(response.data.StatusCode==200)
                {
                 ...
                 localStorage.setItem("data_entry_toggle", "Completed !!"); 
